...
if __name__ == "__main__":
    ...
    parser.add_argument("-f", "--filename", type=str, default="loco.png",
                        help="File to be sent, default: loco.png")
    ...
    parser.add_argument("-s", "--max_segment_size", type=int, default=25000,
                        help="Maximum segment size, default: 25000")
